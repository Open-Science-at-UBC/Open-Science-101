# **OS 101 Unit 4: Benefits of Open Science**
...
Open Science acts like a super-fertilizer to make science grow faster and stronger. Here's a quick review on how it does this.
 ...
 - **OS accelerates the research process** – data, methods, analytical techniques, and code can be re-used;
 - **OS limits unnecessary research** -- publication of methods that have led to dead ends in research helps others in the research community to avoid making the same mistakes.
